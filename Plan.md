...
**1.17 Проверка поля «Владелец» на не валидные значения**
* Пустое поле

*Ожидаемым результатом является, появления сообщения «Поле обязательно для заполнения»*

**1.18-1.19 Проверка поля «CVC/CVV» на не валидные значения**
* Пустое поле
* Однозначное число (#1)
...
**1.20 Проверка стоимости заказа**
...
**1.21 В случаи проверки записи при успешной оплате**
...
**1.21 В случаи проверки отклоненной операции по карте**
